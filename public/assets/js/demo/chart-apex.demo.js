...
var handleCandlestickChart = function () {
	...
	var chart = new ApexCharts(document.querySelector('#apex-candelstick-chart'), options);
	chart.render();
};
...
var handleHeatmapChart = function () {
	...
	var chart = new ApexCharts(document.querySelector('#apex-heatmap-chart'), options);
	chart.render();
};
